...
public:
    string minWindow(string s, string t) {
        ...
        for (int r = 0; r < s.length(); ++r)
        {
            ...
            {
                // Log the most minimum window size continously.
                ...
                windowHashmap[s[l]]--;
                // If this was in our tHashmap, do checkedCharacters-- and end the while loop.
                // This forces us to search for the next character to fill our missing hole.

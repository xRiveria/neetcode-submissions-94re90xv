...
// This happens naturally because BFS uses a queue (FIFO).
// So when you pop a cell from the queue, you are guaranteed this is the shortest possible path to that cell.
// Why? Because any longer path would have had to go through more layers, and those layers haven’t been processed yet as they're behind in the queue.

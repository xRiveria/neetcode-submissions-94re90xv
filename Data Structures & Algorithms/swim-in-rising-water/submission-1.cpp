...
public:
    int swimInWater(vector<vector<int>>& grid) {
        ...
        // This PQ auto sorts based on the fastest time thus far. 
        while (!minHeap.empty())
        {
            ...
            for (const auto& dir : directions)
            {
                ...
                // t = the time required to reach the current cell
                // grid[neiR][neiC] = the earliest time you’re allowed to step into the neighbor cell

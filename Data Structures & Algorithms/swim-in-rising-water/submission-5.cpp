...
public:
    int swimInWater(vector<vector<int>>& grid) {
        ...
        // Think of this as simulating water rising step by step.
        // As it rises, lands of interconnecting cells are combined where possible.
        // At a certain time t, the land that has the starting cell and the land which has the last cell connect.
        // Wny? Because we only connect cells when both are ≤ current water level t, which is the minimum time. 
        // This is our answer. 

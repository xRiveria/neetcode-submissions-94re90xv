...
public:
    ...
    string reorganizeString(string s) {
        ...
        {
            // Image AABA
            // A goes in. Becomes previous.
            // B goes in. A still has stuff. Goes back to heap. B Becomes previous.
            // A goes in. B (previous) is empty and maxHeap is empty.
            // Inserting A again = fail. Byebye!

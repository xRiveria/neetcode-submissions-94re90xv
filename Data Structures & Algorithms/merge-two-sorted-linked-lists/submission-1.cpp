...
public:
    ListNode* mergeTwoLists(ListNode* list1, ListNode* list2) {
        ...
        {
            ListNode* sortedReturn = mergeTwoLists(list1->next, list2);
            list1->next = sortedReturn;
            return list1;
        }
        else
        {
            ListNode* sortedReturn = mergeTwoLists(list1, list2->next);
            list2->next = sortedReturn;
            return list2;
        }

...
public:
    int leastInterval(vector<char>& tasks, int n) {
        ...
        // A queue works here because the first element inserted is always guaranteed to run first.
        // This is because insertion is dependent on t, which increments linearly.
        // Tasks finish cooling down in the same order they were put into cooldown.
        // Only the earliest task can become available.

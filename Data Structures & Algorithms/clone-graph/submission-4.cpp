...
public:
    ...
    // This means that the current node must already exist for us to push back the newly duplicated nodes.
    // We then move on to duplicate the neighbors accordingly.

...
public:
    int lengthOfLongestSubstring(string s) {
        // Stores the index of most recent appearence of a character.
        // This allows us to jump our leftBound to that character + 1, effectively skipping all numbers before it and itself.

...
public:
    ...
    int ladderLength(string beginWord, string endWord, vector<string>& wordList) {
        ...
        {
            // We attempt to mutate each character at each position.
            // After mutation, if the word exists, we add it to the queue. 
        ...
        while (!q.empty())
        {
            ...
            for (int i = 0; i < size; ++i)
            {
                ...
                {
                    // If we've visited this word before, ignore.
                    // If we have hots -> dots, they're both in the adj of one another.
                    // We don't want to revisit them over and over agian and cause an infinite loop!
